...
PLUGINLIB_EXPORT_CLASS(astar_global_planner::AstarGlobalPlannerRos, nav_core::BaseGlobalPlanner)
...
namespace astar_global_planner{
    ...
    AstarGlobalPlannerRos::AstarGlobalPlannerRos(std::string name, costmap_2d::Costmap2DROS* costmap_ros_) : 
                costmap_(NULL), initialized_(false), allow_unknown_(true),planner_(NULL)
    {
        initialize(name, costmap_ros_);
    }
    AstarGlobalPlannerRos::AstarGlobalPlannerRos(std::string name, costmap_2d::Costmap2D* costmap, std::string global_frame) :
                costmap_(NULL), initialized_(false), allow_unknown_(true),planner_(NULL)
    {
